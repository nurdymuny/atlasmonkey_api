            ...
            when 'text'
              ...
              case limit
                when nil, 0..0x3fffffff;
                  ...
                  raise(ActiveRecordError, "The limit on text can be at most 1GB - 1byte.")
              end
            when 'integer'
            ...
            when 'datetime'
              ...
              case precision
                when 0..6;
                  ...
                  raise(ActiveRecordError, "No timestamp type has precision of #{precision}. The allowed range of precision is from 0 to 6")
              end
            else
              super
          end
