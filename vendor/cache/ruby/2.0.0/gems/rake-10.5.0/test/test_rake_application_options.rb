...
class TestRakeApplicationOptions < Rake::TestCase
  ...
  def test_require
    ...
    open 'reqfile.rb', 'w' do |io|
      io << 'TESTING_REQUIRE << 1'
    end
    open 'reqfile2.rb', 'w' do |io|
      io << 'TESTING_REQUIRE << 2'
    end
    open 'reqfile3.rake', 'w' do |io|
      io << 'TESTING_REQUIRE << 3'
    end
